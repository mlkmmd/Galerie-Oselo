...
<div class="card">
    ...
    <div class="card">
        ...
        <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
            ...
            <a href="index.php?controller=artwork&action=index" class="btn btn-secondary">View All Artworks</a>
            <a href="index.php?controller=warehouse&action=index" class="btn btn-secondary">View All Warehouses</a>
        </div>
    </div>
</div>
